...
import 'package:flutter_notes_app/screens/add_edit_screen.dart';
...
final DatabaseHelper _databaseHelper = DatabaseHelper();
        ...
        actions: [
          IconButton(onPressed: ()async{
            ...
            color: Colors.white,
             ...
             IconButton(onPressed: () => _showDeleteDialog(context),
           icon: Icon(
            Icons.delete,
            color: Colors.white,
             )),
  ...
  Future<void> _showDeleteDialog(BuildContext context) async{
    ...
    content: Text("¿Esta seguro que quiere borrar esta nota?", style: TextStyle(
    ...
    actions: [
      ...
      TextButton(onPressed: () => Navigator.pop(context, true), child: Text(
        "Borrar",
        style: TextStyle(
          color: const Color.fromARGB(255, 194, 10, 10),
          fontWeight: FontWeight.w600,
